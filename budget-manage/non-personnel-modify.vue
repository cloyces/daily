    ...
    <div class="donation-manage">
        ...
        <Row class="common">
            ...
            <Col class="com-value" span="5">
                <InputNumber  class="value-input" :min="0" :max="999999999" readonly
                              ...
                              @on-change="setInputChange" v-model="postList.printingExpenses.total"></InputNumber>
            ...
            <Col class="com-total" span="5">
                {{postList.subtotal.totalValue}}
            </Col>
            <Col class="com-total" span="4">
                {{postList.subtotal.financialAidValue}}
            </Col>
            <Col class="com-total" span="5">
                {{postList.subtotal.otherAidValue}}
            </Col>
            <Col class="com-total" span="5">
                <span>/</span>
            </Col>
            ...
            <Col class="com-total" span="5">小计</Col>
            <Col class="com-total" span="5">
                {{postList.subtotalTwo.totalValue}}
            </Col>
            <Col class="com-total" span="4">
                {{postList.subtotalTwo.financialAidValue}}
            </Col>
            <Col class="com-total" span="5">
                {{postList.subtotalTwo.otherAidValue}}
            </Col>
            <Col class="com-total" span="5">
                <span>/</span>
            </Col>
            ...
            <Col class="com-total" span="5">
                {{postList.totalPublicFunds.totalValue}}
            </Col>
            <Col class="com-total" span="4">
                {{postList.totalPublicFunds.financialAidValue}}
            </Col>
            <Col class="com-total" span="5">
                {{postList.totalPublicFunds.otherAidValue}}
            </Col>
            <Col class="com-total" span="5">
                <span>/</span>
            </Col>
        ...
        <Drawer v-model="drawer"
            ...
            <Row class="common">
                ...
                <Table v-if="listPre=='officeDetailList'" :columns="tableColumns" :data="postList.officeDetailList" class="m-table" ref="table"  border>
                ...
                <Table v-if="listPre=='commissionChargeDetailList'" :columns="tableColumns" :data="postList.commissionChargeDetailList" class="m-table" ref="table"  border>
                    <template  slot-scope="{ row,index }" slot="compositionDetails">
                        <Input type="text" :maxlength="30"  v-model="row.compositionDetails" v-if="list!='maintenanceFeeBus'"  class="value-input2"></Input>
                        <span v-if="list=='maintenanceFeeBus'">{{row.compositionDetails}}</span>
                    </template>
...
<script>
  export default {
    ...
    methods: {
      initList(){
        this.$http.get('/api/budgetManage/queryBudgetFundsPublicProject?publicId='+this.$route.query.id).then(res=>{
          this.postList =  res.result.budgetFundsPublicDetail;
        })
      },
      editDetails(item){
        this.drawer = true;
