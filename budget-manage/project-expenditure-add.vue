    ...
    <div class="donation-manage">
        ...
        <Row class="common">
            ...
            <div v-for="(item , index) in postList.budgetSecondConstitutes">
                ...
                <Col class="com-value" span="3">{{item.constituteMoney}}</Col>
        ...
        <Drawer v-model="drawer"
            ...
            <!--<Row class="common">-->
                ...
                <!--<div v-for="(item,index) in totalList">-->
                    ...
                    <!--<Col span="1" class="com-value"><InputNumber :min="0" :max="9999999" v-model="item.number"  class="value-input" @on-blur="getTotal(index)" @on-change="getChangeTotal($event,index)"></InputNumber></Col>-->
                    <!--<Col span="1" class="com-value"><InputNumber :min="0" :max="999999999" v-model="item.price" class="value-input" @on-blur="getTotal(index)" @on-change="getChangeTotal($event,index)"></InputNumber></Col>-->
                    <!--<Col span="2" class="com-value"><InputNumber :min="0" :max="999999999" v-model="item.detailPrice" readonly class="value-input"></InputNumber></Col>-->
                    ...
                    <!--<Col span="2" class="com-value"><Input type="text" :maxlength="50" v-model="item.governmentPurchaseMethod" class="value-input"></Input></Col>-->
    ...
    methods: {
      sureSubmit(){
        if(this.postList.firstProject.year&&this.postList.firstProject.projectName&&this.postList.firstProject.projectCode){
          this.$http.post('/api/budgetManage/saveBudgetProject',this.postList).then(res=>{
